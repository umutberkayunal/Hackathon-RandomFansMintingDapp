...
import {connectWallet, getCurrentWalletConnected, getTokensOfOwner} from "../utils/interact";
...
const Header = observer(() => {
  const connectWalletPressed = async () => {
    ...
    appStore.account = walletResponse.address;
  };
    ...
    if (window.ethereum) {
      window.ethereum.on("accountsChanged", async (accounts) => {
        if (accounts.length > 0) {
          appStore.account = await accounts[0];
          appStore.status = "";
        } else {
          appStore.account = "";
          appStore.status =
  ...
  return (
    <>
      <Head>
        <title>Random Fans NFT Dapp</title>
        ...
        <div className="flex items-center container mx-auto max-w-7xl justify-between h-full">
          ...
          <nav aria-label="Main Menu">
            <ul className="flex items-center space-x-8">
              ...
              <li className="hover:text-purple-500 hover:border-purple-500 cursor-pointer px-4 py-2 font-extrabold text-purple-300 border border-purple-300 rounded-md">
                ...
                >
                  {appStore?.account?.length > 0 ? (
                    "Connected: " +
                    String(appStore.account).substring(0, 6) +
                    "..." +
                    String(appStore.account).substring(38)
                  ) : (
                    <span>Cüzdan Bağlama</span>
                  )}
                </a>
              </li>
            </ul>
          ...
          <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-6">
              ...
              <li>
                <a
                  href="https://twitter.com/cankayachain"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
              ...
              <li>
                <a
                  href="https://discord.gg/zBnUV7kd"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
              ...
              <li>
                <a
                  href="https://www.instagram.com/cankayablockchain/?utm_medium=copy_link"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
              ...
              <li>
                <a
                  href="https://tr.linkedin.com/company/cankayablockchain"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
